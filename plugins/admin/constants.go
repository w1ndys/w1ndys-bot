...
const (
	...
	featureStatus              = "plugin_status"
	featureStatusDisplay       = "插件状态"
	featureStatusDescription   = "查询指定目标插件的意图与实际状态"
	featureStatusCommand       = "插件状态"
	featureGroupEnable         = "plugin_group_enable"
	featureGroupEnableDisplay  = "启用当前群插件"
	featureGroupEnableDesc     = "为当前群启用指定目标插件"
	featureGroupEnableCommand  = "启用当前群插件"
	featureGroupDisable        = "plugin_group_disable"
	featureGroupDisableDisplay = "禁用当前群插件"
	featureGroupDisableDesc    = "为当前群禁用指定目标插件"
	featureGroupDisableCommand = "禁用当前群插件"
)
